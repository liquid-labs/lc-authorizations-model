...
func ListItems(baseQuery *orm.Query, accessRoute caps.AccessRoute, pageRequest PageRequest, ctx context.Context) (int, terror.Terror) {
  if baseQuery == nil {
    return 0, terror.BadRequestError(`Request does not resolve to a base query. Contact customer support if you believe this is a bug.`, nil)
  }
  ...
  if count, err := query.SelectAndCount(); err != nil {
    return 0, terror.ServerError(`Problem retrieving item list.`, err)
  } else {
    return count, nil
  }
}
